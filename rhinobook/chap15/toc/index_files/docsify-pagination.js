;(function (global, factory) {
  ...
  function pagination(vm, _ref) {
    ...
    try {
      ...
      var index = crossChapter
        ? all.findIndex(isALinkTo(path))
        : group.findIndex(function (item) {
  ...
  var template = {
    ...
    inner: function inner(data, options) {
      return [
        data.prev &&
          '\n        <div class="pagination-item pagination-item--previous">\n          <a class="pagination-btn xpath_not" href="' +
            data.prev.href +
  ...
  function install(hook, vm) {
    ...
    hook.afterEach(function (html) {
      let url = vm.route.file.split('/')
      if (url[1] === 'home.md') return html
